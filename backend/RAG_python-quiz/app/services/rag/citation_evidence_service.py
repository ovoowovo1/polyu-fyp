...
from app.services.ai.ai_service import generate_text_completion
...
def _build_cited_answer_payload(
    answer_text: str,
    source_nodes: Sequence[NodeWithScore],
) -> tuple[str, List[EvidenceCitation], List[Dict[str, Any]]]:
    ...
    if normalized_answer and not answer_with_citations:
        citations, answer_with_citations = _fallback_citation_payload(normalized_answer, source_nodes)
    return normalized_answer, citations, answer_with_citations
