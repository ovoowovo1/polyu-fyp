...
const messages = {
  'zh-TW': {
    ...
    'source.empty': '沒有文件',
    'source.emptyHint': 'Upload PDFs, images or links, then select sources for chat context.',
    'source.loadFailed': '載入文件失敗',
    'source.ready': 'Ready',
    'source.uploadPdf': 'Upload Source',
    'source.uploadLink': 'Upload Link',
    'source.pickPdfFailed': 'Failed to pick source files',
    'source.uploadFailed': '上傳失敗',
    'source.reingest': '重新匯入原始 PDF',
    'source.reingestComplete': '重新匯入成功，共 {{count}} 個文字區塊。',
  ...
  en: {
    ...
    'source.reingest': 'Reimport original PDF',
    'source.reingestComplete': 'Reimported successfully: {{count}} chunks.',
